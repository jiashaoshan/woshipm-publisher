...
| 🔥 热点获客发文 | TrendRadar热点 → 产品分析 → AI挑选 → LLM文章 → Pexels封面 → WordPress API 发布 | `woshipm-hotspot-publish.py` |
...
TrendRadar(新智元RSS→V2EX降级) → 产品分析 → AI挑选 → LLM生成获客文章 → Pexels封面 → WordPress AJAX API 发布
